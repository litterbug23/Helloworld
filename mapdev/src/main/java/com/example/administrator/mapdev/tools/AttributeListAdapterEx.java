 ...
 */
public class AttributeListAdapterEx extends BaseAdapter {
    ...
    AttributeItemEx[] items;

    DateFormat formatter = DateFormat.getDateTimeInstance(DateFormat.SHORT,
            DateFormat.SHORT);

    String TAG = "AttributeListAdapterEx";

    /**
     * Constructor
     */
    public AttributeListAdapterEx(Context context, Field[] fields,
        ...
        this.registerDataSetObserver(new DataSetObserver() {
            ...
            public void onChanged() {
                ...
                AttributeListAdapterEx.this.items = new AttributeItemEx[AttributeListAdapterEx.this.editableFieldIndexes.length];

            }
        });
    }

    public AttributeListAdapterEx(Context context, FeatureLayer featureLayer,
                                  String typeIdFieldName) {
        this.context = context;
        this.lInflator = LayoutInflater.from(context);
        ...
        for (Field field : this.fields) {
            typeNames.add(Field.toEsriFieldType(field.getFieldType()));
        }
        this.typeIdFieldName = typeIdFieldName;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AttributeItemEx item = (AttributeItemEx) getItem(position);
